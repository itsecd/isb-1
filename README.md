...
### Выбор варианта:
Каждый студент индивидуально выполняет собственный вариант задания.
Номер варианта соответсвует вычислению позиции свой фамилии в списке группы по модулю 10 + 1, то есть остаток от деления на 10 + 1 (так как варинаты начинаются с 1, а не с 0).
